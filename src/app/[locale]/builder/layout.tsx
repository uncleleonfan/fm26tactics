      ...
      <section className="max-w-3xl mx-auto px-4 py-16 space-y-12">
        <div>
          ...
          <p className="text-text-secondary leading-relaxed mb-3">
            ...
            all without downloading any software. Note: the Builder exports images (SVG/PNG) and text/JSON files, 
        ...
        <div>
          ...
          <ol className="space-y-3 text-text-secondary">
            ...
            <li className="flex gap-3">
              ...
              <span><strong className="text-text-primary">Export and share</strong> — Save your tactic as an SVG/PNG image or TXT/JSON file. Note: .fmf export is not supported — you'll need to manually recreate the tactic in Football Manager 2026 using the exported reference.</span>
            </li>
          </ol>
        </div>
