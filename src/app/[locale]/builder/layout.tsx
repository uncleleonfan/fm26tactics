...
export function generateMetadata({ params }: { params: { locale: string } }): Metadata {
  return generateLocaleSEO({
    ...
    en: {
      ...
      description:
        "Build custom Football Manager 2026 tactics with our free interactive FM26 tactic builder. Design separate in-possession and out-of-possession shapes, add movement arrows, assign roles and duties, and export both phases as PNG, SVG, TXT or JSON — no download required.",
      keywords: [
        ...
        "fm26 in possession out of possession builder", "fm26 phase tactic builder",
      ],
    },
    tr: {
  ...
  mainEntity: [
    {
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "The FM26 Tactic Builder is a free, browser-based tool for creating custom Football Manager 2026 tactics. It supports dual-phase design: position your players separately for the in-possession and out-of-possession phases, add movement arrows to show tactical intent, and get automatic shape recognition and transition analysis — plus every FM26 player role, duty, and team instruction.",
      },
    },
    {
      "@type": "Question",
    ...
    },
    {
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "Use the Export button to save your custom tactic as an SVG or PNG image — either the active phase or both phases side by side — or as a TXT/JSON file, with the full lineup, roles, duties, and team instructions visible, ready to recreate in Football Manager 2026. Please note: the Builder cannot export .fmf files — Football Manager's proprietary tactic format is not supported by any third-party tool. You will need to manually recreate the tactic in-game using the exported image or text as a reference.",
      },
    },
    {
      "@type": "Question",
    ...
    {
      "@type": "Question",
      name: "Can the FM26 Tactic Builder export .fmf files for direct import into the game?",
      acceptedAnswer: {
        "@type": "Answer",
        text: "No. The .fmf format is Football Manager's proprietary, compressed binary format with no public specification or SDK. No third-party tool can generate .fmf files. The Builder exports SVG, PNG, TXT, and JSON formats instead — use these as a visual reference to manually recreate your tactic in Football Manager 2026's in-game Tactics screen.",
      },
    },
  ],
};
      ...
      <section className="max-w-3xl mx-auto px-4 py-16 space-y-12">
        <div>
          ...
          <p className="text-text-secondary leading-relaxed mb-3">
            ...
            all without downloading any software. It supports dual-phase design: shape your team separately
            for the in-possession and out-of-possession phases, add movement arrows to communicate tactical
            intent, and review automatic shape recognition and transition analysis before exporting both
            phases side by side. Note: the Builder exports images (SVG/PNG) and text/JSON files,
            not .fmf files — Football Manager's proprietary format cannot be generated by any third-party tool.
          </p>
        ...
        <div>
          ...
          <ol className="space-y-3 text-text-secondary">
            ...
            <li className="flex gap-3">
              ...
              <span><strong className="text-text-primary">Design each phase</strong> — Switch between the In Possession and Out of Possession tabs to position players for both phases, add movement arrows, and check the automatic shape and transition analysis.</span>
            </li>
            <li className="flex gap-3">
            ...
            <li className="flex gap-3">
              ...
              <span><strong className="text-text-primary">Export and share</strong> — Save your tactic as an SVG/PNG image (single phase or both phases) or TXT/JSON file. Note: .fmf export is not supported — you'll need to manually recreate the tactic in Football Manager 2026 using the exported reference.</span>
            </li>
          </ol>
        </div>
