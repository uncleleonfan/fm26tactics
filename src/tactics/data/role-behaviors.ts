...
const behaviors: RoleBehavior[] = [
  ...
  { roleId: "advanced-forward", duty: "attack", possession: { width: .3, depth: .2, centrality: .7, attacking: .95, support: .45, penetration: .95, chanceCreation: .4 }, outOfPossession: { defensiveResponsibility: .15, pressing: .4, defensiveWidth: .2, defensiveDepth: .2, centralProtection: .25 }, movement: { forward: .9, backward: .05, inside: .5, outside: .3, halfSpace: .55, overlap: .05, underlap: .35 } },
  { roleId: "pressing-forward", duty: "defend", possession: { width: .35, depth: .5, centrality: .6, attacking: .35, support: .5, penetration: .25, chanceCreation: .2 }, outOfPossession: { defensiveResponsibility: .6, pressing: .85, defensiveWidth: .35, defensiveDepth: .5, centralProtection: .4 }, movement: { forward: .35, backward: .35, inside: .4, outside: .3, halfSpace: .45, overlap: 0, underlap: 0 } },
  { roleId: "pressing-forward", duty: "support", possession: { width: .35, depth: .4, centrality: .6, attacking: .45, support: .55, penetration: .3, chanceCreation: .25 }, outOfPossession: { defensiveResponsibility: .5, pressing: .8, defensiveWidth: .35, defensiveDepth: .4, centralProtection: .4 }, movement: { forward: .5, backward: .3, inside: .4, outside: .3, halfSpace: .45, overlap: 0, underlap: 0 } },
  { roleId: "pressing-forward", duty: "attack", possession: { width: .35, depth: .3, centrality: .6, attacking: .6, support: .5, penetration: .4, chanceCreation: .3 }, outOfPossession: { defensiveResponsibility: .35, pressing: .75, defensiveWidth: .3, defensiveDepth: .3, centralProtection: .35 }, movement: { forward: .65, backward: .25, inside: .4, outside: .3, halfSpace: .45, overlap: 0, underlap: 0 } },
