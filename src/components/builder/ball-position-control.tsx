...
export function BallPositionControl({ ballZone, onChange }: BallPositionControlProps) {
  ...
  return (
    <div className="absolute bottom-3 left-1/2 -translate-x-1/2 z-10 max-w-[calc(100%-1.5rem)] rounded-xl border border-[#1C2436] bg-background-secondary/95 backdrop-blur-xs shadow-[0_4px_24px_rgba(0,0,0,0.5)] px-2.5 py-2 animate-slide-up">
      {/* Scenario shortcuts */}
