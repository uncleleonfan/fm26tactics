      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div className="text-center mb-12">
          <div className="inline-flex items-center gap-2 mb-3">
            ...
            <span className="text-xs font-bold text-text-muted uppercase tracking-widest">{t("communityData")}</span>
          </div>
          <h2 className="text-3xl sm:text-4xl font-extrabold tracking-tight mb-3">
            <span className="gradient-text">{t("communitySubtitle").split(" ")[0]}</span>{" "}
            {t("communitySubtitle").split(" ").slice(1).join(" ")}
          </h2>
