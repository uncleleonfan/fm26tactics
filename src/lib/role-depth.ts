...
export const roleDepth: Record<string, RoleDepth> = {
  "sweeper-keeper": {
    ...
    radar: [
      ...
      { attribute: "First Touch", rating: 90 },
  ...
  "goalkeeper": {
    ...
    radar: [
      { attribute: "Aerial Reach", rating: 95 },
      { attribute: "Reflexes", rating: 85 },
      { attribute: "Handling", rating: 88 },
      { attribute: "Positioning", rating: 85 },
      { attribute: "Command of Area", rating: 90 },
  ...
  "full-back": {
    ...
    radar: [
      { attribute: "Tackling", rating: 90 },
      { attribute: "Stamina", rating: 88 },
      { attribute: "Acceleration", rating: 85 },
      { attribute: "Crossing", rating: 80 },
      { attribute: "Work Rate", rating: 82 },
  ...
  "wing-back": {
    ...
    radar: [
      ...
      { attribute: "Crossing", rating: 92 },
      { attribute: "Dribbling", rating: 88 },
      { attribute: "Acceleration", rating: 80 },
      { attribute: "Work Rate", rating: 85 },
      { attribute: "Off the Ball", rating: 78 },
    ],
  },
  ...
  "overlapping-centre-back": {
    ...
    radar: [
      ...
      { attribute: "Acceleration", rating: 80 },
      { attribute: "Positioning", rating: 75 },
    ],
  },
