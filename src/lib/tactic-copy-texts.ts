...
MID: Tracking Winger (Su) | Deep-Lying Playmaker (Su) | Advanced Playmaker (At) | Tracking Winger (Su)
ATT: Inside Forward (At) | Centre Forward (Su) | Inside Forward (At)
...
MID: Wing-Back (Su) | Pressing Central Midfielder (De) | Deep-Lying Playmaker (Su) | Pressing Central Midfielder (De) | Wing-Back (Su)
...
KEY: The 4-4-2 pressing shape — CF and AM lead the press, wingers tuck in.`,
...
MID: Pressing Central Midfielder (De) x2 | Deep-Lying Playmaker (De)
ATT: Centre Forward (At) | Target Forward (At)
...
PLAYER ROLES
GK: Sweeper Keeper (Su)
DEF: Playmaking Wing-Back (At) | CD (De) | CD (De) | Playmaking Wing-Back (At)
MID: Deep-Lying Playmaker (De) | Pressing Central Midfielder (De)
AM: Inside Forward (Su) | Inside Forward (Su)
ATT: Centre Forward (At) | Centre Forward (At)
...
KEY: The box midfield (DLP+PCM+2 IFs) rotates constantly. Two-footed players preferred.`,
...
MID: Wing-Back (At) | Pressing Central Midfielder (De) | Deep-Lying Playmaker (Su) | Wing-Back (At)
AM: Inside Forward (Su) | Inside Forward (Su)
ATT: Centre Forward (At)
...
IN TRANSITION
Counter: ON | Counter-Press: OFF
GK Distribution: Long Kick to CF | Distribute Quickly: ON
...
MID: Deep-Lying Playmaker (De) | Pressing Central Midfielder (De)
ATT: Inside Forward (At) | Centre Forward (At) | Inside Forward (At)
...
MID: Winger (At) | Pressing Central Midfielder (De) | Deep-Lying Playmaker (De) | Winger (At)
AM: Free Role (At)
...
KEY: The Free Role is the shadow striker — drops into the hole and launches counters.`,
...
MID: Pressing Central Midfielder (De) | Deep-Lying Playmaker (Su)
ATT: Winger (At) | Target Forward (At) | Centre Forward (At) | Winger (At)
