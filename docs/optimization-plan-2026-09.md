...
*v2.1 更新：2026-08-29（新增 §2b 多语言策略评估，D2 改为渐进式方案）｜ 状态：Batch 1 ✓（含 N7 ✓ GA4 Key events 已标记，2026-08-29）+ Batch 2 ✓ + Batch 3 可执行项 ✓（2026-08-29：N13/N15/N16/N17 完成，N15 已决策不做 .fmf 导出，N14/N18 观察中，N19 Q4 再议）｜ 下一步：9 月底数据复盘（§5 看板）*
